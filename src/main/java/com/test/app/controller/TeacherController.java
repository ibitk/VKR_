...
public class TeacherController {
    ...
    public String teacher(Model model, Principal principal) {
        ...
        var currentUser = (User) ((UsernamePasswordAuthenticationToken) principal).getPrincipal();
        ...
        var student = studentClassService.getStudentsByCuratorId(currentUser.getId());
